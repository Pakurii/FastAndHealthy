...
const LoginPage=()=>{
    return(
        <SafeAreaView style={styles.container}>
                ...
                <ImageBackground style={styles.loginFooterImages} source={require('../../../assets/images/loginFooterImage.png')}>
                
                    <Image style={styles.loginFooterTopImage} source={require('../../../assets/images/loginFooterImageBackground.png')}></Image>
